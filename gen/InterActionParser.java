...
public class InterActionParser extends Parser {
	...
	public static class StrContext extends ExprContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InterActionVisitor ) return ((InterActionVisitor<? extends T>)visitor).visitStr(this);
	...
	public static class LogicOperateContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InterActionVisitor ) return ((InterActionVisitor<? extends T>)visitor).visitLogicOperate(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AssignOperateContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InterActionVisitor ) return ((InterActionVisitor<? extends T>)visitor).visitAssignOperate(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ParentsContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof InterActionVisitor ) return ((InterActionVisitor<? extends T>)visitor).visitParents(this);
			else return visitor.visitChildren(this);
		}
	}
